    ...
    public class Transcript
    {
        ...
        public string GenerateTranscript()
        {
            ...
            if(this.type == "Program")
            {
                ...
                GenerateSemesterSection(gfx, font, smallFont, page2, 4, 420);
        ...
        public void GenerateSemesterSection(XGraphics gfx,XFont font,XFont smallFont, PdfPage page1, int semester,int y)
        {
            gfx.DrawString("YEAR "+semester+" - SEMESTER "+semester, font, XBrushes.Black, new XRect(15, y, page1.Width, page1.Height), XStringFormats.TopLeft);
            y += 10;
            ...
            gfx.DrawString("Semester Average: " + this.student.GetAverageForSemester(semester), font, XBrushes.Black, new XRect(330, y, page1.Width, page1.Height), XStringFormats.TopLeft);
            //Just a theory on how this might work
            string honors = this.student.GetAverageForSemester(semester) >= 80 ? "Yes" : "No";
            y += 10;
